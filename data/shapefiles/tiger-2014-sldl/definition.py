...
boundaries.register('2014-sldl',
    name='United States State Legislative District Lower Chamber (2014)',
	singular='United States State Legislative District Lower Chamber (2014)',
    ...
    #licence_url='',
    data_url='ftp://ftp2.census.gov/geo/tiger/TIGER2014/SLDL/',
    #notes='',
    encoding='iso-8859-1',
)
