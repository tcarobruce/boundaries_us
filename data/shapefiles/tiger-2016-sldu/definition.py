...
boundaries.register('2016-sldu',
    name='United States State Legislative District Upper Chamber (2016)',
	singular='United States State Legislative District Upper Chamber (2016)',
    ...
    #licence_url='',
    data_url='https://www2.census.gov/geo/tiger/TIGER2016/SLDU/',
    #notes='',
    encoding='iso-8859-1',
)
